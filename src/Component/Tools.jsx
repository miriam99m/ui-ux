...
const styles = {
  ToolsContainer:
    "w-[1083px] flex flex-col gap-[50px] mb-[90px] max-xl:w-[84vw]",
  ...
  ToolsChildrenDiv:
    "h-[148px] border-[1px] border-[#525252] rounded-b-[24px] flex flex-row justify-center align-center items-center gap-[12px]",
  ToolsChildrenImage:
    "w-[100px] h-[100px] p-[24px] bg-center bg-no-repeat flex flex-col items-center justify-center border-[1px] border-[#525252] rounded-[82px]",
};
